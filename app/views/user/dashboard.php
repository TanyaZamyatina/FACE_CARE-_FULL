...
<body>
    ...
    <section class="container user">
        ...
        <div class="user-info">
            <p><b>Привет, <?=$data['user']['name']?></b></p>
            <p><b>Контактный телефон:</b> <?=$data['user']['tel']?></p>
            <p><b>Email:</b> <?=$data['user']['email']?></p>

            <form action="/user/dashboard" method="POST" class="form_exit_btn">
                <input type="hidden" name="exit_btn">
                <button type="submit" class="exit_btn">Выйти</button>
            </form>
        </div>
    </section>
